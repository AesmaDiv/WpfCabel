...
namespace CardinalSplineTest
{
    public class CardinalSplineShape : Shape
    {
        ...
        public CardinalSplineShape()
        {
            ...
            _Points.Add(new Point(30, 20));
            _Points.Add(new Point(10, 30));
            Points = _Points;
        ...
        public CardinalSplineShape(Color color, double thickness, bool isDashed)
        {
            PointCollection _Points = new PointCollection();
            _Points.Add(new Point(10, 10));
            _Points.Add(new Point(30, 20));
            ...
            if (isDashed) StrokeDashArray = new DoubleCollection() { 5, 2 };
        }
        #endregion
        ...
        void OnMeasurePropertyChanged(DependencyPropertyChangedEventArgs args)
        {
            ...
            using (StreamGeometryContext sgc = _StreamGeometry.Open())
            {
                ...
                PointCollection pnts = cardinalSpline(Points, 1d/4d, Closed);
        ...
        private static PointCollection cardinalSpline(PointCollection pts, double t, bool closed)
        {
            int i, nrRetPts;
            Point p1, p2;
            double tension = t * (3d / 4d); //we are calculating contolpoints.
